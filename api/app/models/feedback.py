...
class FeedbackRequest(BaseModel):
    ...
    message_id: str = Field(pattern=r'^[a-f0-9-]{36}$', description="UUID of the message")
    ...
    explanation: Optional[str] = Field(None, max_length=5000, description="Feedback explanation")
    ...
    @classmethod
    def validate_conversation(cls, v: Optional[List[ConversationMessage]]) -> Optional[List[ConversationMessage]]:
