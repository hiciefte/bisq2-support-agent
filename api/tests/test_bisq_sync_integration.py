"""Tests for Bisq sync integration in KnowledgePipelineService."""
...
class TestBisqSyncIntegration:
    """Test Bisq sync method in KnowledgePipelineService."""
    ...
    def test_pipeline_has_sync_bisq_method(self, pipeline_service):
        """KnowledgePipelineService should have sync_bisq_conversations method."""
    ...
    async def test_sync_bisq_delegates_to_service(
        ...
        with patch(
            ...
            "app.services.knowledge.knowledge_pipeline_service.Bisq2API"
        ), patch(
            "app.services.knowledge.knowledge_pipeline_service.BisqSyncStateManager"
        ) as mock_state_class:
...
class TestMatrixSyncIntegration:
    """Test Matrix sync method in KnowledgePipelineService."""
    ...
    def test_pipeline_has_sync_matrix_method(self, pipeline_service):
        """KnowledgePipelineService should have sync_matrix_conversations method."""
    ...
    async def test_sync_matrix_delegates_to_service(
        ...
        with patch(
            "app.services.knowledge.knowledge_pipeline_service.MatrixSyncService"
        ) as mock_sync_class, patch(
            "app.services.knowledge.knowledge_pipeline_service.PollingStateManager"
        ) as mock_state_class:
            mock_sync_instance = AsyncMock()
