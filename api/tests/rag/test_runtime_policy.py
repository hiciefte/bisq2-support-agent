...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Did you receive my message in the trade chat?",
        "How do I message my mediator in the app?",
        "My mediator messaged me in the trade chat.",
        "The arbitrator wrote to me in the in-app dispute chat.",
